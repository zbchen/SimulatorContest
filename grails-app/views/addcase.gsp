        ...
        <div class="container">
            <div class="row">
                <div class="col-sm-8 col-sm-offset-2 text">
                    <h1><strong>测试用例添加</strong></h1>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-6 col-sm-offset-3 form-box">
                    <div class="form-bottom">
                        <form role="form" action="/TestSuite/create" method="post" class="login-form">
                            <div class="form-group">
                                <label class="sr-only" for="form-username">Username</label>
                                <input type="text" name="name" placeholder="测试集名称" class="form-username form-control" id="form-name">
                                <input type="text" name="timeout" placeholder="超时(秒)" class="form-username form-control" id="form-timeout">
                            </div>
